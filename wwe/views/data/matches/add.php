...
<div class="main">
    ...
    <div class="card mb-5">
        <div class="card-header">
            <h3 class="mb-0">Ajouter un match</h3>
        </div>
        <div class="card-body">
            <form method="post">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="winner_id" name="winner_id" required>
                        ...
                        <?php foreach ($wrestlers as $wrestler): ?>
                            <option value="<?= $wrestler->id ?>" <?= isset($_POST['winner_id']) && $_POST['winner_id'] == $wrestler->id ? 'selected' : '' ?>>
                                <?= $wrestler->name ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="loser_id" name="loser_id" required>
                        ...
                        <?php foreach ($wrestlers as $wrestler): ?>
                            <option value="<?= $wrestler->id ?>" <?= isset($_POST['loser_id']) && $_POST['loser_id'] == $wrestler->id ? 'selected' : '' ?>>
                                <?= $wrestler->name ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="match_type_id" name="match_type_id" required>
                        ...
                        <?php foreach ($matchTypes as $type): ?>
                            <option value="<?= $type->id ?>" <?= isset($_POST['match_type_id']) && $_POST['match_type_id'] == $type->id ? 'selected' : '' ?>>
                                <?= $type->name ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <button type="submit" name="confirm_envoyer" class="btn btn-primary">Ajouter</button>
                </div>
            </form>
        </div>
    </div>
